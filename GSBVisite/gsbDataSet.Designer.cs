...
namespace GSBVisite {
    ...
    public partial class gsbDataSet : global::System.Data.DataSet {
        ...
        public partial class medicamentDataTable : global::System.Data.TypedTableBase<medicamentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public medicamentRow AddmedicamentRow(string MED_DEPOTLEGAL, string MED_NOMCOMMERCIAL, string MED_COMPOSITION, string MED_EFFETS, string MED_CONTREINDIC, float MED_PRIXECHANTILLON, string FAM_CODE) {
            ...
            private void InitClass() {
                ...
                this.columnMED_DEPOTLEGAL.MaxLength = 25;
                this.columnMED_NOMCOMMERCIAL.AllowDBNull = false;
                this.columnMED_NOMCOMMERCIAL.MaxLength = 25;
                this.columnMED_COMPOSITION.AllowDBNull = false;
                this.columnMED_COMPOSITION.MaxLength = 255;
                this.columnMED_EFFETS.AllowDBNull = false;
                this.columnMED_EFFETS.MaxLength = 255;
                this.columnMED_CONTREINDIC.AllowDBNull = false;
...
namespace GSBVisite.gsbDataSetTableAdapters {
    ...
    public partial class medicamentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `medicament` WHERE ((`MED_DEPOTLEGAL` = @p1) AND (`MED_NOMCOMMERCIAL` = @p2) AND (`MED_COMPOSITION` = @p3) AND (`MED_EFFETS` = @p4) AND (`MED_CONTREINDIC` = @p5) AND ((@p6 = 1 AND `MED_PRIXECHANTILLON` IS NULL) OR (`MED_PRIXECHANTILLON` = @p7)) AND (`FAM_CODE` = @p8))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `medicament` SET `MED_DEPOTLEGAL` = @p1, `MED_NOMCOMMERCIAL` = @p2, `MED_COMPOSITION` = @p3, `MED_EFFETS` = @p4, `MED_CONTREINDIC` = @p5, `MED_PRIXECHANTILLON` = @p6, `FAM_CODE` = @p7 WHERE ((`MED_DEPOTLEGAL` = @p8) AND (`MED_NOMCOMMERCIAL` = @p9) AND (`MED_COMPOSITION` = @p10) AND (`MED_EFFETS` = @p11) AND (`MED_CONTREINDIC` = @p12) AND ((@p13 = 1 AND `MED_PRIXECHANTILLON` IS NULL) OR (`MED_PRIXECHANTILLON` = @p14)) AND (`FAM_CODE` = @p15))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::GSBVisite.Properties.Settings.Default.gsbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT `MED_DEPOTLEGAL`, `MED_NOMCOMMERCIAL`, `MED_COMPOSITION`, `MED_EFFETS`, `M" +
                "ED_CONTREINDIC`, `MED_PRIXECHANTILLON`, `FAM_CODE` FROM `medicament`";
        ...
        public virtual int FillBy(gsbDataSet.medicamentDataTable dataTable) {
        ...
        public virtual int Delete(string p1, string p2, string p3, string p4, string p5, global::System.Nullable<float> p7, string p8) {
            if ((p1 == null)) {
        ...
        public virtual int Insert(string p1, string p2, string p3, string p4, string p5, global::System.Nullable<float> p6, string p7) {
            if ((p1 == null)) {
                throw new global::System.ArgumentNullException("p1");
            }
            else {
        ...
        public virtual int Update(string p1, string p2, string p3, string p4, string p5, global::System.Nullable<float> p6, string p7, string p8, string p9, string p10, string p11, string p12, global::System.Nullable<float> p14, string p15) {
            if ((p1 == null)) {
                throw new global::System.ArgumentNullException("p1");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string p2, string p3, string p4, string p5, global::System.Nullable<float> p6, string p7, string p8, string p9, string p10, string p11, string p12, global::System.Nullable<float> p14, string p15) {
