...
namespace GSBVisite
{
    public partial class Form1 : Form
    {
        ...
        private void btnConnexion_Click(object sender, EventArgs e)
        {
           ...
           requete = "select identifiant, mdp, Collaborateur.statut, Collaborateur.nom from utilisateur INNER JOIN Collaborateur on utilisateur.idCollaborateur = Collaborateur.MATRICULE where identifiant ='";
